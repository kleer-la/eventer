...
describe EventMailer do
    ...
    context 'welcome_new_event_participant' do
        ...
        it "should not send early bird prices if EB info is empty" do
            ...
            expect(email.text_part.body.to_s).not_to include "Pronto pago:"
            expect(email.html_part.body.to_s).not_to include "Pronto pago:"
        end
          ...
          it "should send early bird prices if EB info is available" do
            ...
            expect(email.text_part.body.to_s).to include "Pronto pago:"
            expect(email.html_part.body.to_s).to include "Pronto pago:"
        ...
        it "should show 2 person price if present" do
            ...
            expect(email.text_part.body.to_s).to include "En parejas:"
            expect(email.html_part.body.to_s).to include "En parejas:"
