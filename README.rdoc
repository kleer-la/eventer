...
Esta aplicación está basada en Rails 3.2.11.
...
- Tambien es importante setear las variables, by default hay datos para mabientes de prueba:
...
Pongo esta línea para forzar un build+deploy
