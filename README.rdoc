...
(ver alrnativa docker m-as abajo)
...
- Ejecutar todas las pruebas: bundle exec rake
...
- Ejecutar pruebas rápidas: bundle exec rake ci
- Ejecutar pruebas lentas: bundle exec rake slow_tests
