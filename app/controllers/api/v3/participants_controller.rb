...
class Api::V3::ParticipantsController < Api::V3::BaseController
  ...
  def interest
    ...
    result = _interest_event(event_id) if event_id.to_i > 0
    p "3---", result
    if result.present?
...
private
  ...
  def participants_params
    params.require(:participants).permit(:event_type_id,:event_id,:firstname, :lastname, :email, :country_iso, :notes)
  end
end
